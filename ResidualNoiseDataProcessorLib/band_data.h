...
//Data structure for a single residual noise measurement band
class Band
{
public:
...
//Generates data for a set of residual noise measurement bands based on the supplied parameters
class BandData
{
public:
